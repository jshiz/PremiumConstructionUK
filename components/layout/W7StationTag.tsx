  ...
  return (
    <div className="flex justify-center py-8 opacity-45 [@media(hover:none)]:opacity-[0.65] hover:opacity-100 transition-opacity duration-700 ease-out">
      <Link
        ...
        className="group relative inline-flex items-center gap-2 px-3 py-1.5 bg-gradient-to-br from-[#2a2a2a] to-[#1a1a1a] border border-white/5 rounded shadow-2xl transition-colors duration-700 ease-out hover:border-orange-500/50"
      >
        ...
        <img
          ...
          alt=""
          aria-hidden="true"
          className="h-3.5 w-auto opacity-70 group-hover:opacity-100 group-hover:drop-shadow-[0_0_8px_rgba(249,115,22,0.6)] transition-all duration-700 ease-out"
        />

        <span className="text-[9px] uppercase font-black tracking-[0.2em] text-zinc-500 group-hover:text-zinc-300 transition-colors duration-700 ease-out">
